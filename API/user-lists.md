# User Lists [](#page:user-lists)

## User Lists [](#page:user-lists,header:user-lists-user-lists)

The List resource allows you to view a User’s Lists.

Get Lists

[GET](#page:user-lists,header:user-lists-user-lists-get)

`/users/{username}/lists`

Returns a User’s Lists. Private Lists will only display when authenticated as the owner. Accepts [Pagination](#page:home,header:home-pagination) parameters.
...
## List [](#page:user-lists,header:user-lists-list)

Get List Items

[GET](#page:user-lists,header:user-lists-list-get)
